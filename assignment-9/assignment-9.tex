...
I think that we are allowed to use constraint solvers in this course, so I put this expression into Wolfram Alpha to solve for \(T_{c}\).
The resulting value of \(T_{c}\) is \qty{2051.73}{\pico\s}.
\section*{Question 2}
\label{sec:orgfe0cd48}
